...
- Обратимость Markdown ↔ структура покрывается тестами на наборе документов
  (см. 14.6, TC-ED-01): структура → Markdown → структура должна давать тот же результат
...
Обязательные тесты — в 14.6 (TC-DATE-01…TC-DATE-07): 29 февраля, дата без года, переход
